...
describe('Integration Tests for getting an admin overview of networking platforms, organisations and projects', function () {
    ...
    it('Getting an overview, only admin of organisation and projects', function () {
        ...
        dbDsl.createOrganization('2', {networkingPlatformId: '1', adminIds: ['1'],
            status: {adminOrg: '1', statusOrg: 'ACCEPTED'}});
        ...
        dbDsl.createProject('2', {adminIds: ['1'], organizationId: '2', created: 501,
            status: {adminProject: '1', statusProject: 'ACCEPTED'}});
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            res.body.organization[0].statusAdmin.should.equals('accepted');
            res.body.organization[0].isOrganizationAdmin.should.equals(true);
            ...
            res.body.organization[0].projects[0].statusAdmin.should.equals('accepted');
            res.body.organization[0].projects[0].isProjectAdmin.should.equals(true);
            ...
            res.body.organization[0].projects[1].statusAdmin.should.equals('pending');
            res.body.organization[0].projects[1].isProjectAdmin.should.equals(true);
            ...
            res.body.organization[0].projects[2].statusAdmin.should.equals('accepted');
            res.body.organization[0].projects[2].isProjectAdmin.should.equals(false);
        });
    });

    it('Getting an overview, only admin of a projects', function () {

        dbDsl.createOrganization('1', {networkingPlatformId: '1', adminIds: ['2']});
        dbDsl.createOrganization('2', {networkingPlatformId: '1', adminIds: ['2'],
            status: {adminOrg: '2', statusOrg: 'ACCEPTED'}});

        dbDsl.createProject('1', {adminIds: ['2'], organizationId: '2', created: 500});
        dbDsl.createProject('2', {adminIds: ['1'], organizationId: '2', created: 501});
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            res.body.organization[0].nameNetworkingPlatform.should.equals('Elyoos');
            res.body.organization[0].statusAdmin.should.equals('accepted');
            res.body.organization[0].isOrganizationAdmin.should.equals(false);
            res.body.organization[0].projects.length.should.equals(2);

            res.body.organization[0].projects[0].name.should.equals('project2Name');
            res.body.organization[0].projects[0].created.should.equals(501);
            res.body.organization[0].projects[0].projectId.should.equals('2');
            res.body.organization[0].projects[0].statusAdmin.should.equals('pending');
            res.body.organization[0].projects[0].isProjectAdmin.should.equals(true);
            ...
            res.body.organization[0].projects[1].projectId.should.equals('1');
            res.body.organization[0].projects[1].statusAdmin.should.equals('pending');
            res.body.organization[0].projects[1].isProjectAdmin.should.equals(false);
        });
    });
});
