...
describe('Integration Tests for getting organizations exported to an networking platform', function () {
    ...
    beforeEach(function () {
        ...
        return dbDsl.init().then(function () {
            ...
            dbDsl.exportOrgToNp({organizationId: '1', npId: '1', created: 500, lastExportTimestamp: 504});
            dbDsl.exportOrgToNp({organizationId: '2', npId: '1', created: 501});
            dbDsl.exportOrgToNp({organizationId: '3', npId: '1', created: 502, lastExportTimestamp: 508});
    ...
    it('Getting organization exported to networking platform', function () {

        return dbDsl.sendToDb().then(function () {
            return requestHandler.login(admin.validAdmin);
        }).then(function () {
            return requestHandler.get('/admin/api/networkingPlatform/orgExportedToNp',
    ...
    it('Getting organization exported to networking platform (Only older then timestamp)', function () {
    ...
    it('Getting organization exported to networking platform (Skip and limit)', function () {
    ...
    it('Only allow to get exported organization when administrator of networking platform', function () {
        return dbDsl.sendToDb().then(function () {
            return requestHandler.login(admin.validAdmin);
        }).then(function () {
            return requestHandler.get('/admin/api/networkingPlatform/orgExportedToNp',
