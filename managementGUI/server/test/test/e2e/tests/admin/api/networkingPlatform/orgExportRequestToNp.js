...
describe('Integration Tests for getting organizations requesting an export to an networking platform', function () {
    ...
    beforeEach(function () {
        ...
        return dbDsl.init().then(function () {
            ...
            dbDsl.exportRequestOrgToNp({organizationId: '1', npId: '1', created: 500});
            dbDsl.exportRequestOrgToNp({organizationId: '2', npId: '1', created: 501});
            dbDsl.exportRequestOrgToNp({organizationId: '3', npId: '1', created: 502});
    ...
    it('Getting organization which request export to networking platform', function () {

        return dbDsl.sendToDb().then(function () {
            return requestHandler.login(admin.validAdmin);
        }).then(function () {
            return requestHandler.get('/admin/api/networkingPlatform/orgExportRequestToNp',
    ...
    it('Getting organization which request export to networking platform (Only older then timestamp)', function () {
    ...
    it('Getting organization which request to export to networking platform (Skip and limit)', function () {
    ...
    it('Only allow to get request organization when administrator of networking platform', function () {
        return dbDsl.sendToDb().then(function () {
            return requestHandler.login(admin.validAdmin);
        }).then(function () {
            return requestHandler.get('/admin/api/networkingPlatform/orgExportRequestToNp',
